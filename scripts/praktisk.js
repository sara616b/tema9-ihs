...
let fag;
let container = document.querySelector("#praktisksek");
...
async function vis(data) {
    ...
    const faqlink = "https://sarahfrederiksen.dk/kea/2_semester/tema9/ihs/wordpress/wp-json/wp/v2/praktisk?per_page=100"
