...
function vis(data) {
    ...
    //ikoner om fag
    document.querySelector("#fagikoner").innerHTML = "<img src='" + data.ikoner[0].guid + "' alt='ikoner'>" + "<img src='" + data.ikoner[1].guid + "' alt='ikoner'>" + "<img src='" + data.ikoner[2].guid + "' alt='ikoner'>" + "<img src='" + data.ikoner[3].guid + "' alt='ikoner'>" + "<img src='" + data.ikoner[4].guid + "' alt='ikoner'>";
